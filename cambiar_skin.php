  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="cambiar_skin.php">Cambiar ropa</a></li>
      </ol>
    </section>
      ...
      <div class="col-md-18">
        <div class="box box-info box-solid">
          <div class="box-header with-border">
            <h3 class="box-title">Cambiar ropa</h3>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Ropa actual</label>
              <input type="text" class="form-control" value="ID <?php echo $skin; ?>" disabled>
            </div>

            <div class="form-group">
              <label>Ropa</label>

              <input type="text" maxlength="3" class="form-control" placeholder="Ingresa el número de skin al que quieres cambiarte.">
            </div>
