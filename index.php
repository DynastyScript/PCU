...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Pop</b>life</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <p>
                  <br>
                  <br>
                  <?php echo $nombre; ?> - <?php echo $admin; ?>
                  <small>Fecha de registro: DD/MM/YY</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="skins/160x160.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Panel 2</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><small><a href="#">comprar premium</a></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-7">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Estadísticas del personaje</h3>
            ...
            <div class="box-body padding">
              <div class="row">
                <div class="col-md-15 col-sm-15">
                  <div class="pad">
                    <div style="position: absolute;margin-left: 360px"><div align="right"><img src="skins/<?php echo $skin?>.png" width="600" height="400"></div> </div>
                    <div style="position: relative;margin-left:15px"><div align="left">
                    <br>
                    <br>
                    <strong>Nombre de usuario</strong>:  <font color="7E7E7E"><?php echo $nombre; ?></font>
                    <br>
                    <br>
                    <strong>Género</strong>: <font color="7E7E7E"><?php echo $genero;?></font>
                    <br>
                    <br>
                    <strong>Edad</strong>: <font color="7E7E7E"><?php echo $edad;?> años</font>
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    <strong>Rango</strong>: <font color="7E7E7E"><?php echo $rango;?></font>
                    <br>
                    <br>
                    <strong>Dinero en mano</strong>: <font color="7E7E7E"> <?php echo $dinero;?>        $ </font>
                    <br>
                    <br>
                    <strong>Dinero en banco</strong>:<font color="7E7E7E"> <?php echo $banco;?>         $</font>
                    <br>
                    <br>
                    <strong>Puntos de rol</strong>:<font color="7E7E7E"> <?php echo $reputacion;?> </font>
  ...
  <footer class="main-footer">
    ...
    <!-- Modificar en el <a href'""> con la página de facebook !-->
    <strong>Copyright &copy; 2018-2019 <a href="https://adminlte.io"> PopLife</a>.</strong> <div align="right">Dynasty & iExpert</div>
  </footer>
